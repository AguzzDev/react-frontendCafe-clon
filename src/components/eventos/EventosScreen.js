                ...
                <div className="flex flex-col mx-auto w-9/12 mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-8 gap-y-12 lg:gap-y-20 xl:gap-y-28 mt-8">
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={imageneseventos1}></img>
                            <div className="p-5">
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={imageneseventos2}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Grupo de estudio</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={imageneseventos3}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Grupo de estudio</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={imageneseventos4}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Grupo de estudio</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={imageneseventos5}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Grupo de estudio</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={imageneseventos6}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Grupo de estudio</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-8 gap-y-12 lg:gap-y-20 xl:gap-y-28 mt-8">
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={grabacion1}></img>
                            <div className="p-5">
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={grabacion2}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Encuentros</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={grabacion3}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Encuentros</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={grabacion4}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Encuentros</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg">
                            <img style={{ width: "500px" }} src={grabacion5}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Encuentros</h3>
                        ...
                        <div className="rounded overflow-hidden flex flex-col md:mt:16 shadow-lg mb-28">
                            <img style={{ width: "500px" }} src={grabacion6}></img>
                            <div className="p-5">
                                <h3 className="text-xs tracking-wide text-green-500">Encuentros</h3>
                                ...
                                <p className="text-md mb-5 text-gray-900 font-small">#FECSession donde <a target="_blank" className="text-green-500 underline" href="https://twitter.com/LazioB">Ezequiel Boehler</a> nos cuenta por qué está bueno diseñar la recolección de datos desde el comienzo del desarrollo de un producto web y cómo podemos arrancar.</p>
