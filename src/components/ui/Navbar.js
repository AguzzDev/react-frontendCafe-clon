        ...
        <>
            <header className="hidden lg:flex w-screen p-1 shadow-md">
                <nav className="flex items-center justify-between w-11/12 xl:w-3/4 mx-auto">
                    <div className="flex flex-row  items-center">
                        <Link to="/">
                            <img src="https://cdn.sanity.io/images/0mjeop5f/production/d9800e6d32de33d7539652677d0bfee09696428b-920x147.svg" className="h-12 p-2 text-white rounded-full" alt="Logo FrontendCafe"></img>
                        </Link>
                    </div>
                    <div className="flex flex-row items-center text-sm space-x-2 lg:space-x-5">
                        ...
                        <a target="_blank" className="bg-indigo-400 rounded text-white font-medium  md:w-auto hover:bg-indigo-500 py-2 pl-5 pr-5 whitespace-nowrap" style={{ transition: "all .15s ease" }} href="https://discord.gg/frontendcafe">Sumate a Discord</a>
                    </div>
                </nav>
            </header>
            {/* Mobile */}
            <header className="flex lg:hidden w-screen p-1 shadow-md">
                ...
                <Dropdown isOpen={openDropdown} toggle={handleDropdown}>
                    ...
                    <DropdownMenu className="absolute top-14 left-0 w-full flex flex-col space-y-3 bg-white z-50 shadow-md pb-5">
                        ...
                        <DropdownItem><a target="_blank" className="bg-indigo-400 rounded text-white text-center font-medium text-sm hover:bg-indigo-500 py-2 pl-5 pr-5 whitespace-nowrap w-1/6 mx-auto" style={{ transition: "all .15s ease" }} href="https://discord.gg/frontendcafe">Sumate a Discord</a></DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </header>
        </>
