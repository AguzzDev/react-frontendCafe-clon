        ...
        <div className="flex justify-center mx-auto w-10/12 md:w-full mt-40">
            <div className="flex flex-col">
                <div className="flex flex-row">
                    ...
                    <img className="ml-2" src={hearth}></img>
                </div>
                <div className="flex justify-center mt-5 mb-24">
                    <a target="_blank" className="bg-indigo-400 rounded p-2 text-white font-medium pr-5 pl-5 md:w-auto hover:bg-indigo-500" href="https://discord.com/invite/frontendcafe">Sumate a Discord</a>
                </div>
            </div>
        </div>
    )
