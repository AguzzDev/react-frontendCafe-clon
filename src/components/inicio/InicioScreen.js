  ...
  return (
    <>
      ...
      <div style={{ height: '500px', width: '100%' }} className='relative bg-white bg-opacity-0 mt-5'>
        <img className='absolute object-cover h-full top-0 2xl:right-48 opacity-25 md:opacity-100 z-0' src='https://cdn.sanity.io/images/0mjeop5f/production/8c78642f8a1fa1ed9af834adb7f1fcc53eed1d76-5120x2000.png?w=1280' />
          ...
          <div className='w-auto md:w-1/3 z-10'>
            ...
            <div className='flex flex-col transform translate-x-10 sm:-translate-x-38 md:hidden relative xl:ml-40'>
              ...
              <div className='text-2xl sm:text-4xl font-bold'>
                <span className='inline-block px-2 py-2 text-indigo-500 bg-indigo-100 border-2 border-dashed border-indigo-500' style={{ opacity: '1', transform: 'none' }} />
                <span className='z-10'> en </span>
                <div style={{ width: 'min-content' }} className='mt-2 px-2 py-2 bg-yellow-400  border-2 border-dashed border-yellow-600'>FrontendCafé</div>
              </div>
              <div className='mt-5'>
