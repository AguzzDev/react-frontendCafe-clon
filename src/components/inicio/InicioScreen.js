...
import { InicioSomosScreen } from './InicioSomosScreen'
...
export const InicioScreen = () => {
    return (
        <>
            ...
            <div style={{ height: "500px", width: "100%" }} className="relative bg-white bg-opacity-0 mt-5">
                <img className="absolute object-cover h-full top-0 2xl:right-48 opacity-25 md:opacity-100 z-0" src="https://cdn.sanity.io/images/0mjeop5f/production/8c78642f8a1fa1ed9af834adb7f1fcc53eed1d76-5120x2000.png?w=1280"></img>
                <div className="flex items-center bg-cover bg-center justify-between h-full w-9/12 mx-auto">
                    <div className="w-auto md:w-1/3 z-10">
                        <div className="hidden md:flex flex-col relative xl:ml-40">
                            ...
                            <div className="mt-5">
                                <a target="blank_" className="bg-indigo-400 rounded p-2 text-white font-medium pr-5 pl-5 md:w-auto hover:bg-indigo-500 mt-10" href="https://discord.com/invite/frontendcafe">Sumate a Discord</a>
                            </div>
                        </div>
                    ...
                    <div className="hidden sm:grid md:grid-cols-2 md:grid-rows-3 md:gap-10">
                        <div className="row-start-1 col-start-2">
                            <div className="flex justify-center items-center relative w-24 lg:w-32 h-20 lg:h-24 rounded-lg bg-green-500">
                                <div style={{ transform: "rotate(-15deg)" }} className="z-10 absolute top-0 left-0 w-24 lg:w-32 h-20 lg:h-24 rounded-lg bg-green-400">
                                </div>
                                <div className="z-20 text-white font-bold text-center lg:text-left">
                                    <p className="text-2xl lg:text-3xl">+18</p><p className="text-md">Proyectos</p>
                                </div>
                            </div>
                        </div>
                        <div className="row-start-2 col-start-1">
                            <div className="flex justify-center items-center relative w-24 lg:w-32 h-20 lg:h-24 rounded-lg bg-yellow-400">
                                <div style={{ transform: "rotate(-15deg)" }} className="z-10 absolute top-0 left-0 w-24 lg:w-32 h-20 lg:h-24 rounded-lg bg-yellow-500">
                                </div>
                                <div className="z-20 text-white font-bold text-center lg:text-left">
