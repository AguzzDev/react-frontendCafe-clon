                                ...
                                >
                                    <div className="flex flex-col md:flex-row">
                                        ...
                                        <div className="flex flex-col leading-3 mt-3 md:mt-0 md:ml-3">
                                            ...
                                            <h2 className="mt-1 text-xs font-medium text-gray-700"><i class="fas fa-map-marker-alt mr-1 ml-1"></i>{dataC.pais}</h2>
                                            <h2 className="mt-2 text-md font-medium tracking-tighter text-green-500">En búsqueda activa</h2>
                                            <div className="flex flex-row mt-2">

                                                <a target="_blank" href={dataC.redes.correo} style={{ height: "26px", width: "26px", borderRadius: "50%", marginRight: "5px" }} className="bg-gray-600 cursor-pointer">
                                                    <div style={{ marginLeft: "4.5px", marginTop: "4.5px" }} >
                                                        <i class="fas fa-envelope text-white"></i>
                                                    </div>
                                                </a>
                                                <a target="_blank" href={dataC.redes.linkedin} style={{ height: "26px", width: "26px", borderRadius: "50%", marginRight: "5px" }} className="bg-gray-600 cursor-pointer">
                                                    <div style={{ marginLeft: "5.8px", marginTop: "4.5px" }} >
                                                        <i class="fab fa-linkedin text-white"></i>
                                                    </div>
                                                </a>
                                                <a target="_blank" href={dataC.redes.github} style={{ height: "26px", width: "26px", borderRadius: "50%", marginRight: "5px" }} className="bg-gray-600 cursor-pointer">
                                                    <div style={{ marginLeft: "5px", marginTop: "4.5px" }} >
                                                        <i class="fab fa-github text-white"></i>
                                                    </div>
                                                </a>
                                                <a target="_blank" href={dataC.redes.twitter} style={{ height: "26px", width: "26px", borderRadius: "50%", marginRight: "5px" }} className="bg-gray-600 cursor-pointer">
                                                    <div style={{ marginLeft: "5px", marginTop: "4.5px" }} >
                                                        <i class="fab fa-twitter text-white"></i>
                                                    </div>
                                                </a>
                                                <a target="_blank" href={dataC.redes.web} style={{ height: "26px", width: "26px", borderRadius: "50%", marginRight: "5px" }} className="bg-gray-600 cursor-pointer">
                                                    <div style={{ marginLeft: "4.5px", marginTop: "4.5px" }} >
